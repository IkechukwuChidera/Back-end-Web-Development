			...
			<div class="row">
				<div class="col-lg-8 post-list">
					...
					<section class="post-area">
						...
						<div class="single-post-item">   
							<figure>
								<img class="post-img img-fluid" src="{{asset('/img/posts/p4.jpg')}}" alt="">
							</figure>
							<h3>
								<a href="blog-details">Big Savings On Gas While You Travel</a>
							</h3>
						...
						<div class="single-post-item"> {{asset('/')}}  .blade.php
							<figure>
								<img class="post-img img-fluid" src="{{asset('/img/posts/p5.jpg')}}" alt="">
							</figure>
							<h3>
								<a href="blog-details.blade.php">Tourism Is Back In Full Swing In Cancun Mexico</a>
							</h3>
							<p>orem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore
								magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip.</p>
							<a href="blog-details.blade.php" class="primary-btn text-uppercase mt-15">continue Reading</a>
							<div class="post-box">
								<div class="d-flex">
									<div>
										<a href="#">  
				...
				<div class="col-lg-4 sidebar">
					...
					<div class="single-widget protfolio-widget">
						...
						<p>
							...
							money on boot camp whenyou can get. Boot camps have its supporters andits detractors.
						</p>
						<ul>
					...
					<div class="single-widget category-widget">
						<h4 class="title"> Our Post Categories</h4>
						<ul>
